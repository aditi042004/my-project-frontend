...
// --- Page Navigation ---
const PAGES = { HOME: 'Home', NLP_TOOL: 'NLP Tool', GAME: 'Game', CHATBOT: 'Chatbot', PROGRESS: 'Dashboard' };
const PAGE_COMPONENTS = { 'Home': 'home', 'NLP Tool': 'nlp_tool', 'Game': 'game', 'Chatbot': 'chatbot', 'Dashboard': 'progress' };
...
const GlobalStyles = () => (
    <style>{`
        ...
        .select-custom {
            background-color: #374151; border: 1px solid #4b5563; border-radius: 0.75rem; padding: 0.75rem 2.5rem 0.75rem 1rem; color: white;
        ...
        /* New Styles for NLP Tool */
        .file-drop-zone {
            display: flex; flex-direction: column; align-items: center; justify-content: center;
            padding: 2rem; border: 2px dashed #4b5563; border-radius: 1rem;
            background-color: rgba(17, 24, 39, 0.5); cursor: pointer; transition: background-color 0.2s;
        }
...
// --- NLP Tool Page (REDESIGNED and Centered) ---
        ...
        <div className="flex-grow flex flex-col items-center justify-center w-full">
            <div className="card-main w-full">
                <div className="text-center">
                    <h2 className="text-3xl font-bold text-white">NLP Analysis Tool</h2>
                    <p className="text-gray-400 mt-2 mb-8">Upload a CSV file to get started.</p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
                    ...
                    <button onClick={handleProcess} disabled={isLoading || !csvFile} className="btn btn-primary w-full sm:w-auto disabled:bg-gray-500 disabled:cursor-not-allowed">
                        {isLoading ? <Spinner /> : 'Process Analysis'}
                    </button>
                </div>
            ...
            {nlpResult && (
                <div className="card-main mt-8 w-full">
                    <h3 className="text-2xl font-bold mb-4 text-green-300">Results: {nlpResult.title}</h3>
...
const ProgressPage = ({ navigateTo, progressData, clearProgressData }) => {
    ...
    return (
        <div className="card-main w-full">
            ...
            {trackedWords.length === 0 ? (<div className="text-center py-12"><h3 className="text-2xl font-semibold text-gray-300">No Progress Tracked Yet</h3><p className="text-gray-500 mt-2">Play the 'Word Challenge' game to start building your personalized learning path.</p><button onClick={() => navigateTo('nlp_tool')} className="mt-6 btn btn-primary">Go to NLP Tool &rarr;</button></div>) : (<>
